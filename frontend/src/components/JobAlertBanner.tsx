...
export const JobAlertBanner: React.FC<{ compact?: boolean }> = ({ compact = false }) => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-[#001428] via-[#002244] to-[#0a3560] rounded-3xl p-6 sm:p-10 text-white shadow-xl border border-blue-900/50 my-10">
      ...
      {/* Acceso Directo al Grupo Oficial de WhatsApp */}
      <div className="relative z-10 max-w-xl mx-auto mt-8 pt-6 border-t border-white/10 text-center">
        <p className="text-xs text-slate-300 mb-3">
          ¿Prefieres recibir vacantes al instante en tu celular? 📲
        </p>
        <a
          href="https://chat.whatsapp.com/F3LjBjLYwSl3TzLQUoe70b"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#25D366] hover:bg-[#1EBE5D] text-slate-950 font-extrabold text-xs sm:text-sm rounded-2xl transition-all duration-200 shadow-lg shadow-emerald-950/40 cursor-pointer"
        >
          ...
          Unirme al Grupo Oficial en WhatsApp
        </a>
      </div>
    </div>
  );
