  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#0F2942] via-[#001428] to-[#0B1C30] text-white pt-16 pb-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight font-['Plus_Jakarta_Sans'] leading-tight">
            ...
            <span className="bg-gradient-to-r from-sky-400 via-blue-300 to-emerald-300 bg-clip-text text-transparent">
          ...
          >
            ...
            <div className="md:col-span-3">
              <button
                type="submit"
                className="w-full h-full min-h-[46px] bg-[#0051d5] hover:bg-[#0041ab] text-white font-bold text-sm rounded-xl transition-all shadow-md shadow-blue-600/30 flex items-center justify-center gap-2 cursor-pointer"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
          <div>
            <div className="inline-flex items-center gap-1 text-xs font-bold text-emerald-600 bg-emerald-50 border border-emerald-200 px-2.5 py-0.5 rounded-full mb-2">
              <Zap className="w-3 h-3 text-emerald-600" /> Vacantes Verificadas
            </div>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#001428] font-['Plus_Jakarta_Sans']">
              ...
              >
                <div>
                  ...
                  {job.salaryMin && job.salaryMax && (
                    <div className="bg-emerald-50/70 border border-emerald-200/70 text-emerald-800 text-xs font-bold px-3 py-1.5 rounded-xl mb-4 inline-flex items-center gap-1.5">
                      <span>💰</span>
                      <span>
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
                ...
                <div className="bg-white/10 backdrop-blur-sm p-3.5 rounded-xl border border-white/10 col-span-2 sm:col-span-1">
                  <div className="text-2xl font-black text-amber-400">PDF ATS</div>
              ...
              <div className="pt-4 flex flex-wrap gap-4">
                <Link
                  ...
                  className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-extrabold px-6 py-3.5 rounded-xl text-sm transition-all shadow-lg shadow-emerald-500/20 flex items-center gap-2 cursor-pointer"
                >
              ...
              <div className="relative w-full max-w-sm">
                <div className="bg-white rounded-2xl p-4 shadow-2xl text-slate-900 border border-slate-100 transform rotate-1 hover:rotate-0 transition-transform duration-300">
                  <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                    ...
                    <div className="bg-emerald-100 text-emerald-800 text-[10px] font-bold px-2 py-0.5 rounded-full">
      ...
      <section className="bg-white border-t border-slate-200 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="space-y-1">
              <div className="text-3xl sm:text-4xl font-black text-emerald-600 font-['Plus_Jakarta_Sans']">
                32
              </div>
              <div className="text-xs sm:text-sm font-semibold text-slate-500">
